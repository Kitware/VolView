...
describe('applyIntent', () => {
  ...
  /** Applies `source` against the provenance the scene already holds. */
  ...
  // The producer may omit the optional `source`, and then nothing in the scene
  // said the result had been applied: after a reload, Load imported every mask
  // again. The client mints the key instead, so the second Load recognizes it.
