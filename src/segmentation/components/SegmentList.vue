...
// A restore lists its segments before it has read their masks, and a loaded
// labelmap converts after the load that brought it in. Until both are over, an
// empty row is not yet known to be empty.
